...
import LeadsTablePaginationActions from './LeadsTablePaginationActions';
	...
	return (
		<div className="flex flex-col min-h-full sm:border-1 sm:rounded-16 overflow-hidden">
			...
			<TablePagination
				...
				rowsPerPageOptions={[5, 10, 25, 100, { label: 'All', value: data.length + 1 }]}
				colSpan={5}
				count={data.length}
				...
				ActionsComponent={LeadsTablePaginationActions}
			/>
		</div>
	);
};
