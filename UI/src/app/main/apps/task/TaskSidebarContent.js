...
import { openNewTaskDialog } from './store/taskSlice';
...
function TaskSidebarContent(props) {
				...
				<Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
					...
					<div className="p-24">
						<Button
							...
							color="primary"
							className="w-full"
							onClick={ev => dispatch(openNewTaskDialog())}
						>
							New Customer
						</Button>
					</div>
					...
					<List className="pt-0">
						...
						>
							...
							<ListItemText className="truncate" primary="Starred task" disableTypography />
						</ListItem>
					</List>
				</Paper>
			</FuseAnimate>
