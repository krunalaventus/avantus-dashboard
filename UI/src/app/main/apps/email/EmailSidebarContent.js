...
import { openNewEmailDialog } from './store/emailSlice';
...
function EmailSidebarContent(props) {
				...
				<Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
					...
					<List className="pt-0">
						...
						>
							...
							<ListItemText className="truncate" primary="Starred email" disableTypography />
						</ListItem>
					</List>
				</Paper>
			</FuseAnimate>
