...
function UnsubscribeListSidebarContent(props) {
				...
				<Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
					...
					<List className="pt-0">
						...
						<ListItem
							button
							component={NavLinkAdapter}
							to="/apps/unsubscribeList/frequent"
							activeClassName="active"
							className={classes.listItem}
						>
							<Icon className="list-item-icon text-16" color="action">
						...
						<ListItem
							button
							component={NavLinkAdapter}
							to="/apps/unsubscribeList/starred"
							activeClassName="active"
							className={classes.listItem}
						>
							<Icon className="list-item-icon text-16" color="action">
							...
							<ListItemText className="truncate" primary="Starred unsubscribeList" disableTypography />
						</ListItem>
					</List>
				</Paper>
			</FuseAnimate>
...
export default UnsubscribeListSidebarContent;
